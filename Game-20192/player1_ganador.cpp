...
Player1_Ganador::Player1_Ganador(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::Player1_Ganador)
{   
    ui->setupUi(this);
    ...
    ui->graphicsView->setBackgroundBrush(QBrush(QImage(":/Imagenes/Player1_Wins.png"))); //Fondo
...
Player1_Ganador::~Player1_Ganador()
{
    delete ui;
}
